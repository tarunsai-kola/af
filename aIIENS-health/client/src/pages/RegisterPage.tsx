...
export default function RegisterPage() {
  ...
  return (
    <div className="w-full animate-fade-in-up" id="register-page">
      <div className="text-center mb-8">
        <div className="mx-auto w-16 h-16 bg-brand-500/20 rounded-2xl flex items-center justify-center border border-brand-500/30 mb-4 shadow-lg shadow-brand-500/10">
        ...
        <p className="text-slate-300 mt-2">Join AIIENS Health to make a difference</p>
      ...
      <Card glass className="border-slate-700/50 bg-slate-900/60 shadow-2xl backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            {step === 1 && (
              <div className="space-y-5 animate-fade-in">
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest border-b border-slate-700 pb-2">Personal Information</p>
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    id="bloodGroup"
                    className={`w-full bg-slate-950/50 border rounded-lg px-4 py-2.5 text-slate-100 focus:outline-none focus:ring-2 focus:ring-brand-500/50 transition-all ${errors.bloodGroup ? 'border-red-500/50' : 'border-slate-700'}`}
                    {...register('bloodGroup')}
                  >
                ...
                <Button type="button" onClick={goToStep2} className="w-full mt-4 flex items-center gap-2 justify-center py-3.5">
            ...
            {step === 2 && (
              <div className="space-y-5 animate-fade-in">
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest border-b border-slate-700 pb-2">Set Your Password</p>
                ...
                <div className="flex gap-3 mt-4">
                  <Button type="button" variant="outline" onClick={() => setStep(1)} className="flex-1 flex items-center gap-1 justify-center py-3.5 border-slate-600 text-slate-300 hover:bg-slate-800 hover:text-white">
                    <ChevronLeft className="w-4 h-4" /> Back
                  </Button>
                  <Button type="submit" className="flex-1 py-3.5" variant="primary" isLoading={isSubmitting}>
                    Create Account
                  </Button>
                </div>
              </div>
